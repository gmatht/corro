// TRUE gtk4-rs backend adapter (statically linked, safe) for debugging.
use std::cell::RefCell;
use std::rc::Rc;
use crate::core::{DrawContext, Error};

use gtk4_static::{self, gio, glib, cairo, gdk};
use gtk4_static::prelude::*;
use glib::translate::*;
...
#[derive(Clone)]
pub struct Application(pub gtk4_static::Application);
impl Application {
...
#[derive(Clone)]
pub struct Window(pub gtk4_static::Window, CList);
impl Window {
    pub fn new() -> Self { Window(gtk4_static::Window::new(), new_controllers()) }
    ...
    pub fn on_event_key(&self, cb: Box<dyn FnMut(u32, u32) -> i32>) {
        ...
        let ctrl = gtk4_static::EventControllerKey::new();
        ...
        self.0.upcast_ref::<gtk4_static::Widget>().add_controller(ctrl.clone());
...
#[derive(Clone)]
pub struct BoxWidget(pub gtk4_static::Box);
impl BoxWidget {
    pub fn new(o: Orientation, s: i32) -> Self {
                BoxWidget(gtk4_static::Box::new(match o { Orientation::Horizontal => gtk4_static::Orientation::Horizontal, Orientation::Vertical => gtk4_static::Orientation::Vertical }, s))
    }
    pub fn append(&self, c: &impl AsRef<*mut std::ffi::c_void>) { self.0.append(unsafe { &*(c.as_ref() as *const *mut _ as *const gtk4_static::Box) }); }
...
#[derive(Clone)]
pub struct Button(pub gtk4_static::Button);
impl Button {
    pub fn new(label: &str) -> Self { Button(gtk4_static::Button::with_label(label)) }
...
#[derive(Clone)]
pub struct Label(pub gtk4_static::Label);
impl Label {
    pub fn new(text: &str) -> Self { Label(gtk4_static::Label::new(Some(text))) }
...
#[derive(Clone)]
pub struct Entry(pub gtk4_static::Entry, CList);
impl Entry {
    ...
    pub fn set_halign(&self, a: i32) { self.0.set_halign(if a == 1 { gtk4_static::Align::Start } else { gtk4_static::Align::Fill }); }
    pub fn set_valign(&self, a: i32) { self.0.set_valign(if a == 1 { gtk4_static::Align::Start } else { gtk4_static::Align::Fill }); }
    ...
    pub fn connect_focus_in_event<F: FnMut(*mut std::ffi::c_void) -> i32 + 'static>(&self, f: F) -> Result<u64, Error> {
        let f = RefCell::new(f); let c = gtk4_static::EventControllerFocus::new();
    ...
    pub fn connect_button_press<F: FnMut() + 'static>(&self, f: F) -> Result<u64, Error> {
        let f = RefCell::new(f); let ges = gtk4_static::GestureClick::new();
    ...
    pub fn on_key_raw(&self, cb: Box<dyn FnMut(u32, u32) -> bool>) {
        ...
        ctrl.set_propagation_phase(gtk4_static::PropagationPhase::Capture);
        ctrl.connect_key_pressed(move |_, keyval, _, state| {
...
#[derive(Clone)]
pub struct Grid(pub gtk4_static::Grid);
impl Grid {
    pub fn new() -> Self { Grid(gtk4_static::Grid::new()) }
    pub fn attach(&self, c: &impl AsRef<*mut std::ffi::c_void>, l: i32, t: i32, w: i32, h: i32) { self.0.attach(unsafe { &*(c.as_ref() as *const *mut _ as *const gtk4_static::Widget) }, l, t, w, h); }
    pub fn set_visible(&self, v: bool) { self.0.set_visible(v); }
    pub fn set_hexpand(&self, e: bool) { self.0.set_hexpand(e); }
    pub fn set_vexpand(&self, e: bool) { self.0.set_vexpand(e); }
    pub fn set_size_request(&self, w: i32, h: i32) { self.0.set_size_request(w, h); }
...
#[derive(Clone)]
pub struct Canvas(pub gtk4_static::DrawingArea, DrawCb, CList);
impl Canvas {
    pub fn new() -> Self {
                let area = gtk4_static::DrawingArea::new();
...
impl Menu {
    pub fn new() -> Self { Menu(gio::Menu::new()) }
...
#[derive(Clone)]
pub struct MenuBar(pub gtk4_static::PopoverMenuBar);
impl MenuBar {
...
#[derive(Clone)]
pub struct Dialog(pub gtk4_static::Window, CList);
impl Dialog {
    pub fn new() -> Self { Dialog(gtk4_static::Window::new(), new_controllers()) }
    ...
    pub fn append_content_area(&self, c: &impl AsRef<*mut std::ffi::c_void>) { self.0.set_child(Some(unsafe { &*(c.as_ref() as *const *mut _ as *const gtk4_static::Widget) })); }
...
#[derive(Clone)]
pub struct DropDown(pub gtk4_static::DropDown);
impl DropDown {
    pub fn new(items: &[&str]) -> Self {
                let store = gio::ListStore::new::<gtk4_static::StringObject>();
        for &item in items { store.append(&gtk4_static::StringObject::new(item)); }
        DropDown(gtk4_static::DropDown::new(Some(store.clone()), Some(gtk4_static::PropertyExpression::new(gtk4_static::StringObject::static_type(), None::<gtk4_static::PropertyExpression>, "string"))))
    }
...
#[derive(Clone)]
pub struct CheckButton(pub gtk4_static::CheckButton);
impl CheckButton {
    pub fn new(l: &str) -> Self { CheckButton(gtk4_static::CheckButton::with_label(l)) }
...
#[derive(Clone)]
pub struct RadioButton(pub gtk4_static::CheckButton);
impl RadioButton {
    pub fn new(_g: Option<&RadioButton>, l: &str) -> Self { RadioButton(gtk4_static::CheckButton::with_label(l)) }
    pub fn is_active(&self) -> bool { self.0.is_active() }
    pub fn set_active(&self, a: bool) { self.0.set_active(a); }
    pub fn set_visible(&self, v: bool) { self.0.set_visible(v); }
    pub fn set_hexpand(&self, e: bool) { self.0.set_hexpand(e); }
...
#[derive(Clone)]
pub struct TextView(pub gtk4_static::TextView);
impl TextView {
    pub fn new() -> Self { TextView(gtk4_static::TextView::new()) }
    ...
    pub fn set_wrap_mode(&self, _w: i32) { self.0.set_wrap_mode(gtk4_static::WrapMode::WordChar); }
    pub fn set_size_request(&self, w: i32, h: i32) { self.0.set_size_request(w, h); }
    pub fn set_hexpand(&self, e: bool) { self.0.set_hexpand(e); }
    pub fn set_vexpand(&self, e: bool) { self.0.set_vexpand(e); }
    pub fn set_visible(&self, v: bool) { self.0.set_visible(v); }
...
#[derive(Clone)]
pub struct ScrolledWindow(pub gtk4_static::ScrolledWindow);
impl ScrolledWindow {
    pub fn new() -> Self { ScrolledWindow(gtk4_static::ScrolledWindow::new()) }
    pub fn set_child(&self, c: &impl AsRef<*mut std::ffi::c_void>) { self.0.set_child(Some(unsafe { &*(c.as_ref() as *const *mut _ as *const gtk4_static::Widget) })); }
...
#[derive(Clone)]
pub struct Overlay(pub gtk4_static::Overlay);
impl Overlay {
    pub fn new() -> Self { Overlay(gtk4_static::Overlay::new()) }
    pub fn set_child(&self, c: &impl AsRef<*mut std::ffi::c_void>) { self.0.set_child(Some(unsafe { &*(c.as_ref() as *const *mut _ as *const gtk4_static::Widget) })); }
    pub fn add_overlay(&self, c: &impl AsRef<*mut std::ffi::c_void>) { self.0.add_overlay(unsafe { &*(c.as_ref() as *const *mut _ as *const gtk4_static::Widget) }); }
    pub fn set_overlay_pass_through(&self, _c: &impl AsRef<*mut std::ffi::c_void>, _p: bool) {}
    pub fn remove(&self, c: &impl AsRef<*mut std::ffi::c_void>) { self.0.remove_overlay(unsafe { &*(c.as_ref() as *const *mut _ as *const gtk4_static::Widget) }); }
...
impl_asref!(Window, gtk4_static::Window);
impl_asref!(BoxWidget, gtk4_static::Box);
impl_asref!(Label, gtk4_static::Label);
impl_asref!(Entry, gtk4_static::Entry);
impl_asref!(Canvas, gtk4_static::DrawingArea);
impl_asref!(Button, gtk4_static::Button);
impl_asref!(Dialog, gtk4_static::Window);
impl_asref!(DropDown, gtk4_static::DropDown);
impl_asref!(CheckButton, gtk4_static::CheckButton);
impl_asref!(RadioButton, gtk4_static::CheckButton);
impl_asref!(TextView, gtk4_static::TextView);
impl_asref!(Grid, gtk4_static::Grid);
impl_asref!(ScrolledWindow, gtk4_static::ScrolledWindow);
impl_asref!(Overlay, gtk4_static::Overlay);
impl_asref!(MenuBar, gtk4_static::PopoverMenuBar);
...
pub fn create_application() -> Result<Application, Error> { Ok(Application(gtk4_static::Application::new(Some("org.corro.Corro"), gio::ApplicationFlags::empty()))) }

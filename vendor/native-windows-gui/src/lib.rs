// Vendored upstream crate (patched for Win95 dynamic-API loading; see
// vendor/native-windows-gui/README-WIN95.md). Its warnings are upstream's,
// not ours, and fixing them here would diverge the vendored copy for no
// functional gain — suppress them so our build stays warning-clean without
// touching upstream logic.
#![allow(warnings)]
